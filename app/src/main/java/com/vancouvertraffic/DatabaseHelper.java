...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.vancouvertraffic/databases/";

    private static String DB_NAME = "vandata.db";
    ...
    // table name
    private static final String TABLE_CAM = "vancamdata";
